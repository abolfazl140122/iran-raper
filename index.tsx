...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  let playerProgress: PlayerProgress = { chapters: {} };
  let currentLevel = 0;
  let currentChapterId = '';
  let currentQuestion: LevelData | null = null;
  ...
  function updateChapterSelectScreen() {
      ...
      const yasChapterCard = document.querySelector('.chapter-card[data-source="yas.json"]') as HTMLElement;
      const pishroChapterCard = document.querySelector('.chapter-card[data-source="pishro.json"]') as HTMLElement;
      const pishroSoonText = pishroChapterCard.querySelector('.soon-text') as HTMLElement;
  ...
  // --- Game Logic ---
  function populateLevelGrid(chapterTitle: string, chapterId: string) {
    levelGrid.innerHTML = '';
  ...
  async function selectChapter(chapterElement: HTMLElement) {
  ...
  function getNextQuestion(isRetry: boolean): LevelData | null {
  ...
  function startLevel(levelNumber: number, isRetry = false) {
  ...
  // FIX: Corrected typo in type annotation from HTMLButtonButtonElement to HTMLButtonElement
